-- INI SEGURIDAD
    ...
    -- INI MIEMBRO
        ...
        GRANT EXECUTE ON FUNCTION ficha_actor(BIGINT), ficha_premios_pelicula(INT,INT), ficha_pelicula(INT), ficha_oscar_totales(INT) 
        votar_nominados(INT, INT), votar_postulados(INT,INT), postular_pelicula(INT, INT, INT) TO miembro;

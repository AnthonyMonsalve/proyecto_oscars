...
INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (9525, 'Christopher', 'Allen', 'Lloyd', 'M', 'SI', '1925-04-04', '1938-10-22', NULL, 'Stamford, Connecticut, U.S.', 'Christopher Allen Lloyd (born October 22, 1938) is an American actor. He has appeared in many theater productions, films, and on television since the 1960s. He is known for portraying Dr. Emmett "Doc" Brown in the Back to the Future trilogy (1985–1990); and Jim Ignatowski in the comedy series Taxi (1978–1983), for which he won two Emmy Awards', NULL);

--Banda sonora
INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (1525, 'Alan', 'Silvestri', 'Barrios', 'M', 'NO', '1934-07-05', '1950-03-26', 'Anthony', NULL, NULL, NULL);

INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (7025, 'John', 'Victor', 'Colla', 'M', 'NO', '1936-02-01', '1952-10-20', NULL, NULL, NULL, NULL);

--Asistente
INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (9522, 'Pamela', 'Eilerson', 'Merbdel', 'M', 'NO', '1922-08-07', '1954-10-20', 'Luis', NULL, NULL, NULL);
...
INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (5655, 'John', 'Campbell', 'McTiernan', 'M', 'NO', '1970-11-12', '1986-01-31', 'Jr', NULL, NULL, NULL);

--guionista
INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (1597, 'Jeb', 'Stuart', 'Little', 'M', 'NO', '1971-07-10', '1988-04-21', 'Rock', NULL, NULL, NULL);

--Actores principales
INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (3548, 'James', 'Saburo', 'Shigeta', 'M', 'SI', '1910-03-17', '1929-04-17', NULL, 'Honolulu, Oahu, Territory of Hawaii', 'James Saburo Shigeta (japonés :繁田 三郎) (17 de junio de 1929). Actor estadounidense de ascendencia japonesa. Se destacó por sus papeles en The Crimson Kimono (1959), Walk Like a Dragon (1960), Flower Drum Song (1961), Bridge to the Sun (1961), Die Hard (1988) y Mulan (1998). En 1960, ganó el Globo de Oro a la Revelación Más Prometedora - Masculino , junto con otros tres actores.', NULL);

INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (9632, 'Grand', 'Bush', 'Lee', 'M', 'SI', '1945-09-12', '1976-07-31', NULL, 'Los Angeles, California, U.S.', 'Grand Lee Bush (nacido el 24 de diciembre de 1955) es un actor estadounidense de teatro, televisión y grandes películas.', NULL);

--Banda sonora
INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (74511, 'Michael', 'Kamen', 'Arnold', 'M', 'NO', '1949-04-08', '1967-04-14', 'Jr.', NULL, NULL, NULL);

--Encargado de Sonido
INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (2015, 'Kevin', 'Cleary', 'F.', 'M', 'NO', '1938-04-11', '1967-12-24', NULL, NULL, NULL, NULL);
...
INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (2065, 'Steven', 'Alexander', 'Wright', 'M', 'NO', '1939-02-09', '1955-04-15', 'Gerald', NULL, NULL, NULL);

--guionista
INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (4004, 'Grends', 'Stuart', 'Big', 'M', 'NO', '1961-05-02', '1980-04-21', 'Bird', NULL, NULL, NULL);
...
INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (21065, 'Steven', 'Alexander', 'Wright', 'M', 'NO', '1933-03-30', '1955-04-15', 'Gerald', NULL, NULL, NULL);

--guionista
INSERT INTO public.persona(
	doc_identidad, primer_nom, primer_ape, segundo_ape, sexo, es_actor, fecha_nac, fecha_ini_carrera, segundo_nom, a_lugar_nac, a_biografia, fecha_defuncion)
	VALUES (2045, 'Grends', 'Stuart', 'Big', 'M', 'NO', '1968-11-14', '1980-04-21', 'Bird', NULL, NULL, NULL);

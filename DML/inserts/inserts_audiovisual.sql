...
", "Netflix"}', 'A', 1983, '{"Política"}','https://beersandpolitics.com/wp-content/uploads/2019/01/LostiemposdeHarveyMilk.jpg','documental', 0, 0, 0, '{"Estados Unidos"}');
	...
	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va, fotos,clas_audiovisual, total_nomi, total_postu, total_ganador, pais)
	VALUES (5,'Duro de matar', 'Die Hard', 'Die Hard sigue al oficial fuera de servicio del Departamento de Policía de Nueva York John McClane (Bruce Willis) mientras se enfrenta a un grupo de criminales altamente organizados liderados por Hans Gruber (Alan Rickman), que realizan un atraco en un rascacielos de Los Ángeles bajo el pretexto de un ataque terrorista utilizando a rehenes, incluyendo a la esposa de McClane, Holly Gennaro (Bonnie Bedelia), para mantener a raya a la policía', '1986-07-20', 131, '{"20th Century Fox"}', 'C', 1985, '{"Accion"}','https://static.wikia.nocookie.net/doblaje/images/f/f2/Durodematar.jpg/revision/latest?cb=20210525004313&path-prefix=es','largometraje', 0, 0, 0, '{"Estados Unidos"}');

	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va, fotos,clas_audiovisual, total_nomi, total_postu, total_ganador, pais)
	VALUES (6,'La sociedad de los poetas muertos', 'Dead Poets Society', 'Narra el encuentro de un profesor de literatura con un grupo de alumnos durante 1959 en la Welton Academy (Vermont), institución señera y prestigiosa.', '1986-05-20', 128 , '{"Buena Vista Pictures Distribution"}', 'A', 1985, '{"Drama"}','https://drive.google.com/drive/folders/','largometraje', 0, 0, 0, '{"Estados Unidos"}');

-------------- CORTOMETRAJES --------------
	
	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va, fotos,clas_audiovisual, total_nomi, total_postu, total_ganador, pais)
	VALUES (9,'Los nombramientos de Dennis Jennings', 'The Appointments of Dennis Jennings', 'The Appointments of Dennis Jennings es un cortometraje de comedia estadounidense de 1988, protagonizado, coescrito y coproducido por Steven Wright', '1986-09-07', 41 , '{"HBO"}', 'A', 1985, '{"Comedia"}','https://pics.filmaffinity.com/The_Appointments_of_Dennis_Jennings-313589620-msmall.jpg','cortometraje', 0, 0, 0, '{"Estados Unidos"}');

	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va, fotos,clas_audiovisual, total_nomi, total_postu, total_ganador, pais)
	VALUES (10,'Work Experience', 'Work Experience', 'Is a 1989 British short comedy film directed by James Hendrie and starring Lenny Henry and Kathy Burke', '1986-09-07', 51 , '{"Channel Four Films"}', 'A', 1985, '{"Comedia"}','https://pics.filmaffinity.com/work_experience_s-370263560-msmall.jpg','cortometraje', 0, 0, 0, '{"Estados Unidos"}');


	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va, fotos,clas_audiovisual, total_nomi, total_postu, total_ganador, pais)
	VALUES (15,'Caracortadita PARTE 2', 'Scar face DUMP', 'Después de obtener una tarjeta verde a cambio de asesinar a un funcionario del gobierno cubano, Tony Montana (Al Pacino) reclama el tráfico de drogas en Miami. Asesinando brutalmente a cualquiera que se interponga en su camino, Tony finalmente se convierte en el capo de la droga más grande del estado, controlando casi toda la cocaína que llega a Miami. Pero el aumento de la presión de la policía, las guerras con los cárteles de la droga colombianos y su propia paranoia alimentada por las drogas sirven para alimentar las llamas de su eventual caída.', '1986-12-09', 170, '{"Universal Pictures"}', 'C', 1985, '{"Drama","Crimen", "Bélico"}','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSp6Py6zIThAfLViyfCFHT-yfMZ7gFY0imj8WBddOUQfZzAWDYh','largometraje', 0, 0, 0, '{"Estados Unidos"}');

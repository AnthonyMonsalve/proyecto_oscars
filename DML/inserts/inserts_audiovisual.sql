-------------- LARGOMETRAJES --------------
	...
	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va,clas_audiovisual, total_nomi, total_postu, total_ganador)
	VALUES (6,'La sociedad de los poetas muertos', 'Dead Poets Society', 'Narra el encuentro de un profesor de literatura con un grupo de alumnos durante 1959 en la Welton Academy (Vermont), institución señera y prestigiosa.', '1989-05-20', 128 , '{"Buena Vista Pictures Distribution"}', 'A', 1987, '{"Drama"}','largometraje', 0, 0, 0);

-------------- CORTOMETRAJES --------------

	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va,clas_audiovisual, total_nomi, total_postu, total_ganador)
	VALUES (7,'Anna & Bella', 'Anna & Bella', 'Anna & Bella es un cortometraje de animación holandés de 1984de los Países Bajos', '1984-11-10', 41 , '{"Cilia van Dijk"}', 'AA', 1984, '{"Familia"}','cortometraje', 0, 0, 0);
	
	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va,clas_audiovisual, total_nomi, total_postu, total_ganador)
	VALUES (8,'Rays Male Heterosexual Dance Hall', 'Rays Male Heterosexual Dance Hall', 'Es un cortometraje de comedia estadounidense de 1987dirigido por Bryan Gordon', '1987-11-15', 44 , '{"Chanticleer Films", "Discovery Program"}', 'AA', 1987, '{"Comedia"}','cortometraje', 0, 0, 0);
	
	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va,clas_audiovisual, total_nomi, total_postu, total_ganador)
	VALUES (9,'Los nombramientos de Dennis Jennings', 'The Appointments of Dennis Jennings', 'The Appointments of Dennis Jennings es un cortometraje de comedia estadounidense de 1988, protagonizado, coescrito y coproducido por Steven Wright', '1988-09-07', 41 , '{"HBO"}', 'A', 1987, '{"Comedia"}','cortometraje', 0, 0, 0);

	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va,clas_audiovisual, total_nomi, total_postu, total_ganador)
	VALUES (10,'Work Experience', 'Work Experience', 'Is a 1989 British short comedy film directed by James Hendrie and starring Lenny Henry and Kathy Burke', '1989-09-07', 51 , '{"Channel Four Films"}', 'A', 1988, '{"Comedia"}','cortometraje', 0, 0, 0);
...
", "Netflix"}', 'A', 1984, '{"Política"}','documental', 0, 0, 0);
	...
	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va,clas_audiovisual, total_nomi, total_postu, total_ganador)
	VALUES (13,'Women – for America, for the World', 'Women – for America, for the World', 'Es un cortometraje documental estadounidense de 1986 dirigido por Vivienne Verdon-Roe sobre mujeres activistas antinucleares', '1986-10-11', 40, '{"TBS"}', 'B', 1985, '{"Cultura"}','documental', 0, 0, 0);

...
-------------- CORTOMETRAJES --------------
	...
	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va, fotos,clas_audiovisual, total_nomi, total_postu, total_ganador, pais)
	VALUES (8,'Rays Male Heterosexual Dance Hall', 'Rays Male Heterosexual Dance Hall', 'Es un cortometraje de comedia estadounidense de 1987dirigido por Bryan Gordon', '1987-11-15', 44 , '{"Chanticleer Films", "Discovery Program"}', 'AA', 1987, '{"Comedia"}','https://pics.filmaffinity.com/Ray_s_Male_Heterosexual_Dance_Hall_S_C-809613519-mmed.jpg','cortometraje', 0, 0, 0, '{"Estados Unidos"}');
	
	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va, fotos,clas_audiovisual, total_nomi, total_postu, total_ganador, pais)
	VALUES (9,'Los nombramientos de Dennis Jennings', 'The Appointments of Dennis Jennings', 'The Appointments of Dennis Jennings es un cortometraje de comedia estadounidense de 1988, protagonizado, coescrito y coproducido por Steven Wright', '1988-09-07', 41 , '{"HBO"}', 'A', 1987, '{"Comedia"}','https://drive.google.com/drive/folders/','cortometraje', 0, 0, 0, '{"Estados Unidos"}');

	INSERT INTO public.audiovisual(
	 id_audiovi, titulo_espanol, titulo_original, sinopsis, fecha_estreno_cine, duracion_min, distribucion_va, censura, ano_realizacion, genero_va, fotos,clas_audiovisual, total_nomi, total_postu, total_ganador, pais)
	VALUES (10,'Work Experience', 'Work Experience', 'Is a 1989 British short comedy film directed by James Hendrie and starring Lenny Henry and Kathy Burke', '1989-09-07', 51 , '{"Channel Four Films"}', 'A', 1988, '{"Comedia"}','https://drive.google.com/drive/folders/','cortometraje', 0, 0, 0, '{"Estados Unidos"}');

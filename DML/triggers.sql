...
BEGIN
	...
	INSERT INTO tmp_ganador_nominado2veces (
		--id_postuladas_p_pers, ano_oscar,
		--id_rol,	doc_identidad,
		--id_audiovi,	id_nominada,
		ganador
		--, id_categoria
	) SELECT --nominadas.id_postuladas_p_pers, 
			 --nominadas.ano_oscar, id_rol, 
			 --doc_identidad, id_audiovi, id_nominada,
		     ganador
			 --, nominadas.id_categoria 
